...
export function Hero() {
  return (
    <section className="relative min-h-screen flex flex-col justify-between overflow-hidden">
      {/* Top nav */}
      <header className="flex items-center justify-between px-6 md:px-10 py-4 border-b border-border relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 mt-12">
          <div className="md:col-span-6 md:col-start-7 relative min-h-[260px]">
            <DraggableModule
              ...
              delay={0.2}
              className="rounded-md border border-white/10 bg-black/50 backdrop-blur-md p-5 max-w-xl shadow-[0_20px_60px_-20px_rgba(0,0,0,0.6)]"
            >
            ...
            <DraggableModule
              delay={0.35}
              className="mt-6 inline-block rounded-full border border-white/10 bg-black/50 backdrop-blur-md p-2 pl-3"
            >
