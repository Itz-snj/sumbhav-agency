    ...
    <section id="works" ref={sectionRef} className="relative overflow-hidden border-t border-border bg-background">
      <div className="flex h-screen items-stretch">
        <div ref={trackRef} className="flex h-full">
          {/* Intro panel */}
          <div className="w-screen md:w-[60vw] shrink-0 flex flex-col justify-between p-8 md:p-16 border-r border-border">
          ...
          {/* End panel */}
          <div className="w-screen md:w-[40vw] shrink-0 flex items-center justify-center p-16 border-r border-border">
            <a
              href="#contact"
